...
contract AutoShojiru is Ownable, ReentrancyGuard {
    ...
    IERC20 public immutable token; // Shojiru token

    IShojiruFarm public immutable masterchef;
    ...
    /**
     * @notice Constructor
     * @param _token: Shojiru token contract
     * @param _masterchef: MasterChef contract
     * @param _owner: address of the owner
     */
    constructor(
        IERC20 _token,
        IShojiruFarm _masterchef,
        address _owner
    ) public {
        token = _token;
    ...
    /**
     * @notice Reinvests SHOJIRU tokens into MasterChef
     */
    ...
    /**
     * @notice Deposits funds into the Shojiru Vault
     * @param _amount: number of tokens to deposit (in SHOJIRU)
     */
    ...
    /**
     * @notice Withdraws from funds from the Shojiru Vault
     * @param _shares: Number of shares to withdraw
     */
    function withdraw(uint256 _shares) public nonReentrant {
        uint256 userShares = sharesOf[msg.sender];

        require(_shares > 0, "AutoShojiru: Nothing to withdraw");
        require(_shares <= userShares, "AutoShojiru: Withdraw amount exceeds balance");
     ...
     * @return Returns total pending Shojiru rewards
     */
    function calculateTotalPendingShojiruRewards() external view returns (uint256) {
        uint256 amount = masterchef.pendingSHOJIRU(0, address(this));
